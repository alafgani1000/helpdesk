    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                ...
                <!--end: Search Form -->
                <!--begin: Datatable -->
                <table class="table table-striped table-hover responsive" width="100%" id="dt_stage">
                    <thead>
                        <tr>
                            <th title="Field #1">
                                Name
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div id="idmodal-content">
                    <form id="form-stage" action="{{ route('stage.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <span class="m-form__help text-danger" id="help-description">
...
@push('scripts')
    <script>
        ...
        $(function(){
            table = $("dt_stage").DataTable({
                processing:true,
                serverSide:true,
                ajax:{
                    url:"{{ route('stage.data') }}",
                    type:"GET",
                    dataType:"JSON",
                    data:{
                        "_token":"{{csrf_token()}}"
            ...
            $("#form-team").submit(function(event){
                ...
                .fail(function(data){
                    ...
                    if(data.responseJSON.errors.description){
                        $("#help-description").html(data.responseJSON.errors.description);
                    }
